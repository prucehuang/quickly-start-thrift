 ...
 * 
 * Fields can be declared "optional", which ensures they will not be included in
 * the serialized output if they aren't set. Note that this requires some manual
 * management in some languages.
 */
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2017-04-01")
public class Work
		implements org.apache.thrift.TBase<Work, Work._Fields>, java.io.Serializable, Cloneable, Comparable<Work> {
